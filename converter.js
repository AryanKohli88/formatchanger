...
async function main() {
    let job = await promptUser("Available Jobs -\n TRIM :: Divides your audio file into smaller clips. \n FCHANGE (DEFAULT):: Helps you change format/codec of your audio/video file. \n");
    if(job.toLowerCase()==="trim")
    {
